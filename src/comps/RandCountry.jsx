    ...
    return (
        <div className="rand_country">
            <div key={randNum} className="rand_country_card" onClick={() => setSelectedCountry(randCountry)}>
                ...
                <h3>{randCountry.name}</h3>
                <p className="rand_country_region">Region: {randCountry.region}</p>
                <p className="rand_country_capital">Capital: {randCountry.capital}</p>
                <div className="rand_country_pop_area">
                    <p className="rand_country_area">Area: {randCountry.area}</p>
                    <p className="rand_country_population">Population: {randCountry.population}</p>
                </div>
                <p className="rand_country_currency">Currency: {randCountry.currencies?.[0]?.code || "N/A"}</p>
            </div>
        </div>
    )
}
